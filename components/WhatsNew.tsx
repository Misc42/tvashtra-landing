    ...
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between lg:gap-10">
        <div className="flex-shrink-0">
          ...
          <h2 className="text-xl font-semibold leading-tight text-ink lg:text-2xl">
            Six new ops landed since the last release.
          </h2>
          <p className="serif-italic mt-1 text-sm text-muted lg:text-base">
        ...
        <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:flex lg:flex-wrap lg:justify-end lg:gap-3">
          {pills.map((p) => (
            <li key={p.href}>
              ...
              >
                <span className="font-mono text-[0.66rem] uppercase tracking-[0.14em] text-saffron">
                  {p.label}
                </span>
